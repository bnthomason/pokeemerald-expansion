...
extern const u8 Move_FLASH_GLEAM[];
extern const u8 Move_HEALING_TOUCH[];
extern const u8 Move_LIGHT_PULSE[];
extern const u8 Move_ALICORN_CHARGE[];
extern const u8 Move_TORNADO[];
extern const u8 Move_HEALING_CIRCLE[];
extern const u8 Move_FEATHER_STORM[];
extern const u8 Move_PHOTON_BLAST[];
extern const u8 Move_LIGHT_OF_REVIVAL[];
extern const u8 Move_HOLY_SONG[];
extern const u8 Move_HISS[];
extern const u8 Move_TAIL_ATTACK[];
extern const u8 Move_TAIL_SLAM[];
extern const u8 Move_MAELSTROM[];
extern const u8 Move_MYSTIC_BEAM[];
extern const u8 Move_PIXIE_BLAST[];
extern const u8 Move_SPRING_OF_REBIRTH[];
extern const u8 Move_MASS_ATTRACTION[];
extern const u8 Move_GROOM[];
