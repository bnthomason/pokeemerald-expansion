...
enum {
    ...
    CRY_DRACOCEROS_HOLY_CHILD,
    CRY_DRACOCEROS_HOLY_JUVENILE,
    CRY_DRACOCEROS_HOLY_ADULT,
#endif //P_FAMILY_SPOINK

#if P_FAMILY_FAERIAL_HERO
    CRY_FAERIAL_BEAUTY_CHILD,
    CRY_FAERIAL_BEAUTY_JUVENILE,
    CRY_FAERIAL_BEAUTY_ADULT,
#endif //P_FAMILY_SPOINK
};
