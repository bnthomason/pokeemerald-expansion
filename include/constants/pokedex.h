...
enum {
    ...
    //Ryuku
    NATIONAL_DEX_GRASS_STARTER_BASIC,
    NATIONAL_DEX_GRASS_STARTER_STAGE1,
    NATIONAL_DEX_GRASS_STARTER_STAGE2,
    NATIONAL_DEX_FIRE_STARTER_BASIC,
    NATIONAL_DEX_FIRE_STARTER_STAGE1,
    NATIONAL_DEX_FIRE_STARTER_STAGE2,
    NATIONAL_DEX_WATER_STARTER_BASIC,
    NATIONAL_DEX_WATER_STARTER_STAGE1,
    NATIONAL_DEX_WATER_STARTER_STAGE2,
    NATIONAL_DEX_GLIDEAF,
    NATIONAL_DEX_GLIDRONE,
    NATIONAL_DEX_LAMBI,
    NATIONAL_DEX_RAMBI,
    NATIONAL_DEX_NX_NORMAL_FLYING_BASIC,
    NATIONAL_DEX_NX_NORMAL_FLYING_STAGE1,
    NATIONAL_DEX_NX_NORMAL_FLYING_STAGE2,
    NATIONAL_DEX_NX_FLYING_BUG_BASIC,
    NATIONAL_DEX_NX_FLYING_BUG_STAGE1,
    NATIONAL_DEX_NX_FLYING_BUG_STAGE2,
    NATIONAL_DEX_NX_POISON_BASIC,
    NATIONAL_DEX_NX_POISON_STAGE1,
    NATIONAL_DEX_NX_FIGHTING_BASIC,
    NATIONAL_DEX_NX_FIGHTING_STAGE1,
    NATIONAL_DEX_ROCK_BASIC,
    NATIONAL_DEX_ROCK_STAGE1,
    NATIONAL_DEX_ROCK_PSYCHIC_STAGE2,
    NATIONAL_DEX_NX_ROCK_BASIC,
    NATIONAL_DEX_NX_ROCK_STAGE1,
    NATIONAL_DEX_NX_ROCK_FIGHTING_STAGE2,
    NATIONAL_DEX_NX_GROUND_BASIC,
    NATIONAL_DEX_NX_GROUND_STAGE1,
    NATIONAL_DEX_NX_STEEL_BASIC,
    NATIONAL_DEX_NX_STEEL_STAGE1,
    NATIONAL_DEX_NX_STEEL_STAGE2,
    NATIONAL_DEX_NX_GHOST_BASIC,
    NATIONAL_DEX_NX_GHOST_STAGE1,
    NATIONAL_DEX_NX_GHOST_STAGE2,
    NATIONAL_DEX_NX_GRASS_BASIC,
    NATIONAL_DEX_NX_GRASS_STAGE1,
    NATIONAL_DEX_NX_GRASS_STAGE2,
    NATIONAL_DEX_NX_WATER_BASIC,
    NATIONAL_DEX_NX_WATER_STAGE1,
    NATIONAL_DEX_NX_WATER_STAGE2,
    NATIONAL_DEX_NX_ELECTRIC1_BASIC,
    NATIONAL_DEX_NX_ELECTRIC1_STAGE1,
    NATIONAL_DEX_NX_ELECTRIC2_BASIC,
    NATIONAL_DEX_NX_ELECTRIC2_STAGE1,
    NATIONAL_DEX_NX_ICE_BASIC,
    NATIONAL_DEX_NX_ICE_STAGE1,
    NATIONAL_DEX_NX_PSYCHIC_BASIC,
    NATIONAL_DEX_NX_PSYCHIC_STAGE1,
    NATIONAL_DEX_NX_PSYCHIC_STAGE2,
    NATIONAL_DEX_NX_FAIRY_BASIC,
    NATIONAL_DEX_NX_FAIRY_STAGE1,
    NATIONAL_DEX_CHERUBUS,
    NATIONAL_DEX_ANGELUS,
    NATIONAL_DEX_OPHANUS,
    NATIONAL_DEX_SERAPHUS,
    NATIONAL_DEX_DEMONSUS,
    NATIONAL_DEX_NX_LIGHT_GHOST_BASIC,
    NATIONAL_DEX_NX_LIGHT_GHOST_STAGE1,
    NATIONAL_DEX_NX_LIGHT_GHOST_STAGE2,
    NATIONAL_DEX_NX_LIGHT_PSYCHIC_BASIC,
    NATIONAL_DEX_NX_LIGHT_PSYCHIC_STAGE1,
    NATIONAL_DEX_NX_LIGHT_PSYCHIC_STAGE2,
    NATIONAL_DEX_NX_LIGHT_ELECTRIC_BASIC,
    NATIONAL_DEX_NX_LIGHT_ELECTRIC_STAGE1,
    NATIONAL_DEX_NX_LIGHT_ELECTRIC_STAGE2,
    NATIONAL_DEX_NX_LIGHT_FIRE_BASIC,
    NATIONAL_DEX_NX_LIGHT_FIRE_STAGE1,
    NATIONAL_DEX_NX_LIGHT_FIRE_STAGE2,
    NATIONAL_DEX_NX_LIGHT_BASIC,
    NATIONAL_DEX_NX_LIGHT_STAGE1,
    NATIONAL_DEX_NX_LIGHT_STAGE2,
    NATIONAL_DEX_NX_WATER_LIGHT_BASIC,
    NATIONAL_DEX_NX_WATER_LIGHT_STAGE1,
    NATIONAL_DEX_NX_FLYING_LIGHT_BASIC,
    NATIONAL_DEX_NX_FLYING_LIGHT_STAGE1,
    NATIONAL_DEX_NX_GROUND_LIGHT_BASIC,
    NATIONAL_DEX_NX_GROUND_LIGHT_STAGE1,
    NATIONAL_DEX_NX_DARK_BASIC,
    NATIONAL_DEX_NX_DARK_STAGE1,
    NATIONAL_DEX_CELPHIE,
    NATIONAL_DEX_HIPPOCELPH,
    NATIONAL_DEX_SPHOX,
    NATIONAL_DEX_SPHENIX,
    NATIONAL_DEX_GRUFF,
    NATIONAL_DEX_HIPPOGRUFF,
    NATIONAL_DEX_MAJESTEED,
    NATIONAL_DEX_GODSTEED,
    NATIONAL_DEX_FLYDRA,
    NATIONAL_DEX_PSYDRA,
    NATIONAL_DEX_ICEPUP,
    NATIONAL_DEX_SNOWOLF,
    NATIONAL_DEX_SQUEEFISH,
    NATIONAL_DEX_GAOSHANG,
    NATIONAL_DEX_DEFIN,
    NATIONAL_DEX_DRAIR,
    NATIONAL_DEX_DRAERIA,
    NATIONAL_DEX_DRAETHER,
    NATIONAL_DEX_MUSHI,
    NATIONAL_DEX_MUSHISA,
    NATIONAL_DEX_MUSHISHNA,
    NATIONAL_DEX_HYDRA,
    NATIONAL_DEX_SKYDRA,
    NATIONAL_DEX_HOLYDRA,
    NATIONAL_DEX_NOCTOWL_EVOLUTION,
    NATIONAL_DEX_SWELLOW_EVOLUTION,
    NATIONAL_DEX_COPPERAJAH_EVOLUTION,
    NATIONAL_DEX_IX,
    NATIONAL_DEX_CLOUDEON,
    NATIONAL_DEX_QUAKEON,
    NATIONAL_DEX_RADEON,
    NATIONAL_DEX_AUREON,
    NATIONAL_DEX_WISPEON,
    NATIONAL_DEX_DRACEON,
    NATIONAL_DEX_MAGNEON,
    NATIONAL_DEX_BELLEON,
    NATIONAL_DEX_DRACOCEROS_HOLY_CHILD,
    NATIONAL_DEX_DRACOCEROS_HOLY_JUVENILE,
    NATIONAL_DEX_DRACOCEROS_HOLY_ADULT,
    NATIONAL_DEX_NEBUGON_TANK_CHILD,
    NATIONAL_DEX_NEBUGON_TANK_JUVENILE,
    NATIONAL_DEX_NEBUGON_TANK_ADULT,
    NATIONAL_DEX_RAIKYU_MAGE_CHILD,
    NATIONAL_DEX_RAIKYU_MAGE_JUVENILE,
    NATIONAL_DEX_RAIKYU_MAGE_ADULT,
    NATIONAL_DEX_FAERIAL_BEAUTY_CHILD,
    NATIONAL_DEX_FAERIAL_BEAUTY_JUVENILE,
    NATIONAL_DEX_FAERIAL_BEAUTY_ADULT,
    NATIONAL_DEX_IMPYRIAN_IMPERIAL_CHILD,
    NATIONAL_DEX_IMPYRIAN_IMPERIAL_JUVENILE,
    NATIONAL_DEX_IMPYRIAN_IMPERIAL_ADULT,
    NATIONAL_DEX_WINTEGO_NECRO_CHILD,
    NATIONAL_DEX_WINTEGO_NECRO_JUVENILE,
    NATIONAL_DEX_WINTEGO_NECRO_ADULT,
    NATIONAL_DEX_PROTOTYPE_HERO_CHILD,
    NATIONAL_DEX_PROTOTYPE_HERO_JUVENILE,
    NATIONAL_DEX_PROTOTYPE_HERO_ADULT,
    NATIONAL_DEX_BOSS_SINGULARIA,
    NATIONAL_DEX_BOSS_OROBORO,
    NATIONAL_DEX_BOSS_TERMINA,
    NATIONAL_DEX_BOSS_PRINCESS,
    NATIONAL_DEX_BOSS_QUEEN,
    NATIONAL_DEX_BOSS_EMPEROR,
    NATIONAL_DEX_SINGULARIA,
    NATIONAL_DEX_OROBORO,
    NATIONAL_DEX_TERMINA,
    NATIONAL_DEX_PRINCESS,
    NATIONAL_DEX_QUEEN,
    NATIONAL_DEX_EMPEROR,
    NATIONAL_DEX_DRACOCEROS_CHAOS_CHILD,
    NATIONAL_DEX_DRACOCEROS_CHAOS_JUVENILE,
    NATIONAL_DEX_DRACOCEROS_CHAOS_ADULT,
    NATIONAL_DEX_NEBUGON_FIGHTER_CHILD,
    NATIONAL_DEX_NEBUGON_FIGHTER_JUVENILE,
    NATIONAL_DEX_NEBUGON_FIGHTER_ADULT,
    NATIONAL_DEX_RAIKYU_STEALTH_CHILD,
    NATIONAL_DEX_RAIKYU_STEALTH_JUVENILE,
    NATIONAL_DEX_RAIKYU_STEALTH_ADULT,
    NATIONAL_DEX_FAERIAL_MIMICRY_CHILD,
    NATIONAL_DEX_FAERIAL_MIMICRY_JUVENILE,
    NATIONAL_DEX_FAERIAL_MIMICRY_ADULT,
    NATIONAL_DEX_IMPYRIAN_EMPYREAL_CHILD,
    NATIONAL_DEX_IMPYRIAN_EMPYREAL_JUVENILE,
    NATIONAL_DEX_IMPYRIAN_EMPYREAL_ADULT,
    NATIONAL_DEX_WINTEGO_BIO_CHILD,
    NATIONAL_DEX_WINTEGO_BIO_JUVENILE,
    NATIONAL_DEX_WINTEGO_BIO_ADULT,
    NATIONAL_DEX_PROTOTYPE_VILLAIN_CHILD,
    NATIONAL_DEX_PROTOTYPE_VILLAIN_JUVENILE,
    NATIONAL_DEX_PROTOTYPE_VILLAIN_ADULT,
    NATIONAL_DEX_BUTTERFREE_MEGA,
    NATIONAL_DEX_DRAGONITE_MEGA,
    NATIONAL_DEX_NOCTOWL_EVOLUTION_MEGA,
    NATIONAL_DEX_KINGDRA_MEGA,
    NATIONAL_DEX_SWELLOW_EVOLUTION_MEGA,
    NATIONAL_DEX_BEAUTIFLY_MEGA,
    NATIONAL_DEX_DUSTOX_MEGA,
    NATIONAL_DEX_WAILORD_MEGA,
    NATIONAL_DEX_FLYGON_MEGA,
    NATIONAL_DEX_MILOTIC_MEGA,
    NATIONAL_DEX_STARAPTOR_MEGA,
    NATIONAL_DEX_MOTHIM_MEGA,
    NATIONAL_DEX_RHYPERIOR_MEGA,
    NATIONAL_DEX_DUSKNOIR_MEGA,
    NATIONAL_DEX_UNFEZANT_MEGA,
    NATIONAL_DEX_LEAVANNY_MEGA,
    NATIONAL_DEX_SCOLIPEDE_MEGA,
    NATIONAL_DEX_GIGALITH_MEGA,
    NATIONAL_DEX_HYDREIGON_MEGA,
    NATIONAL_DEX_CHANDELURE_MEGA,
    NATIONAL_DEX_TALONFLAME_MEGA,
    NATIONAL_DEX_VIVILLION_MEGA,
    NATIONAL_DEX_GOODRA_MEGA,
    NATIONAL_DEX_NOIVERN_MEGA,
    NATIONAL_DEX_TOUCANNON_MEGA,
    NATIONAL_DEX_VIKAVOLT_MEGA,
    NATIONAL_DEX_KOMMO_O_MEGA,
    NATIONAL_DEX_CORVIKNIGHT_MEGA,
    NATIONAL_DEX_ORBEETLE_MEGA,
    NATIONAL_DEX_COALOSSAL_MEGA,
    NATIONAL_DEX_DRAGAPULT_MEGA,
    NATIONAL_DEX_NX_NORMAL_FLYING_MEGA,
    NATIONAL_DEX_NX_BUG_FLYING_MEGA,
    NATIONAL_DEX_GAOSHANG_MEGA,
    NATIONAL_DEX_DEFIN_MEGA,
    NATIONAL_DEX_PSYDRA_MEGA,
    NATIONAL_DEX_NX_WATER_LIGHT_MEGA,
    NATIONAL_DEX_NX_FLYING_LIGHT_MEGA,
    NATIONAL_DEX_NX_GROUND_LIGHT_MEGA,
    NATIONAL_DEX_SNOWOLF_MEGA,
    NATIONAL_DEX_DRAETHER_MEGA,
    NATIONAL_DEX_MUSHISHNA_MEGA,
    NATIONAL_DEX_HOLYDRA_MEGA,
    NATIONAL_DEX_DRACOCEROS_HOLY_MEGA,
    NATIONAL_DEX_NEBUGON_TANK_MEGA,
    NATIONAL_DEX_RAIKYU_MAGE_MEGA,
    NATIONAL_DEX_FAERIAL_BEAUTY_MEGA,
    NATIONAL_DEX_IMPYRIAN_IMPERIAL_MEGA,
    NATIONAL_DEX_WINTEGO_NECRO_MEGA,
    NATIONAL_DEX_PROTOTYPE_HERO_MEGA,
    NATIONAL_DEX_DRACOCEROS_CHAOS_MEGA,
    NATIONAL_DEX_NEBUGON_FIGHTER_MEGA,
    NATIONAL_DEX_RAIKYU_STEALTH_MEGA,
    NATIONAL_DEX_FAERIAL_MIMICRY_MEGA,
    NATIONAL_DEX_IMPYRIAN_EMPYREAL_MEGA,
    NATIONAL_DEX_WINTEGO_BIO_MEGA,
    NATIONAL_DEX_PROTOTYPE_VILLAIN_MEGA,
    NATIONAL_DEX_DRACOCEROS_TRANSCENDENT,
    NATIONAL_DEX_NEBUGON_TRANSCENDENT,
    NATIONAL_DEX_RAIKYU_TRANSCENDENT,
    NATIONAL_DEX_FAERIAL_TRANSCENDENT,
    NATIONAL_DEX_IMPYRIAN_TRANSCENDENT,
    NATIONAL_DEX_WINTEGO_TRANSCENDENT,
    NATIONAL_DEX_PROTOTYPE_TRANSCENDENT,
};
...
#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI
    ...
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_PROTOTYPE_TRANSCENDENT
