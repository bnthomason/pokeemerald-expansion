...
#define EVO_FRIENDSHIP_ATK_GT_SPATK       50     // Pokémon levels up with friendship ≥ 220 with attack > special attack
#define EVO_MOVE_ATK_EQ_SPATK             51     // Pokémon levels up with friendship ≥ 220 with attack = special attack
#define EVO_MOVE_ATK_LT_SPATK             52     // Pokémon levels up with friendship ≥ 220 with attack < special attack
...
#define SPECIES_FLAG_DRAGON_HERO		(1 << 11)
#define SPECIES_FLAG_TRANSCENSION    	(1 << 12)
