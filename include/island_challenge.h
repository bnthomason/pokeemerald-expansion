...
struct RSIslandChallengeRecord
{
    ...
    /*0x1C*/ struct IslandChallengePokemon party[FRONTIER_PARTY_SIZE];
    /*0xA0*/ u32 checksum;
};

struct IslandChallengeTrainer
{
    u8 facilityClass;
    u8 filler1[3];
...
extern const u8 gChallengeMaleIslandClasses[30];
extern const u16 gChallengeMaleTrainerGfxIds[30];
extern const u8 gChallengeFemaleIslandClasses[20];
extern const u16 gChallengeFemaleTrainerGfxIds[20];
extern const struct TrainerMon gIslandChallengeMons[];
extern const struct IslandChallengeTrainer gIslandChallengeTrainers[];
