...
static const struct LevelUpMove sDracocerosHolyChildLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_HORN_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_GUST),
    LEVEL_UP_MOVE( 5, MOVE_FLASH_GLEAM),
    LEVEL_UP_MOVE( 10, MOVE_AGILITY),
    LEVEL_UP_MOVE( 15, MOVE_HEALING_TOUCH),
    LEVEL_UP_MOVE( 20, MOVE_TORNADO),
    LEVEL_UP_MOVE( 25, MOVE_LIGHT_PULSE),
    LEVEL_UP_MOVE( 30, MOVE_ALICORN_CHARGE),
    LEVEL_UP_END
};

static const struct LevelUpMove sDracocerosHolyJuvenileLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_AGILITY),
    LEVEL_UP_MOVE( 1, MOVE_HEALING_TOUCH),
    LEVEL_UP_MOVE( 1, MOVE_TORNADO),
    LEVEL_UP_MOVE( 26, MOVE_LIGHT_PULSE),
    LEVEL_UP_MOVE( 32, MOVE_ALICORN_CHARGE),
    LEVEL_UP_MOVE( 38, MOVE_HURRICANE),
    LEVEL_UP_MOVE( 44, MOVE_SOLAR_BEAM),
    LEVEL_UP_MOVE( 50, MOVE_HEALING_CIRCLE),
    LEVEL_UP_END
};

static const struct LevelUpMove sDracocerosHolyAdultLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_HEALING_TOUCH),
    LEVEL_UP_MOVE( 1, MOVE_ALICORN_CHARGE),
    LEVEL_UP_MOVE( 1, MOVE_HURRICANE),
    LEVEL_UP_MOVE( 1, MOVE_SOLAR_BEAM),
    LEVEL_UP_MOVE( 57, MOVE_HEALING_CIRCLE),
    LEVEL_UP_MOVE( 64, MOVE_FEATHER_STORM),
    LEVEL_UP_MOVE( 71, MOVE_PHOTON_BLAST),
    LEVEL_UP_MOVE( 78, MOVE_LIGHT_OF_REVIVAL),
    LEVEL_UP_MOVE( 85, MOVE_HOLY_SONG),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sFaerialBeautyChildLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TAIL_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_WATER_GUN),
    ...
    LEVEL_UP_MOVE( 30, MOVE_TAIL_SLAM),
    LEVEL_UP_END
};

static const struct LevelUpMove sFaerialBeautyJuvenileLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_LIFE_DEW),
    LEVEL_UP_MOVE( 1, MOVE_RECOVER),
    LEVEL_UP_MOVE( 1, MOVE_WATER_PULSE),
    LEVEL_UP_MOVE( 26, MOVE_DAZZLING_GLEAM),
    LEVEL_UP_MOVE( 32, MOVE_TAIL_SLAM),
    LEVEL_UP_MOVE( 38, MOVE_MAELSTROM),
    LEVEL_UP_MOVE( 44, MOVE_MYSTIC_BEAM),
    LEVEL_UP_MOVE( 50, MOVE_REST),
    LEVEL_UP_END
};

static const struct LevelUpMove sFaerialBeautyAdultLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_RECOVER),
    LEVEL_UP_MOVE( 1, MOVE_TAIL_SLAM),
    LEVEL_UP_MOVE( 1, MOVE_MAELSTROM),
    LEVEL_UP_MOVE( 1, MOVE_MYSTIC_BEAM),
    LEVEL_UP_MOVE( 57, MOVE_REST),
    LEVEL_UP_MOVE( 64, MOVE_WATER_SPOUT),
    LEVEL_UP_MOVE( 71, MOVE_PIXIE_BLAST),
    LEVEL_UP_MOVE( 78, MOVE_SPRING_OF_REBIRTH),
    LEVEL_UP_MOVE( 85, MOVE_MASS_ATTRACTION),
    LEVEL_UP_END
};
