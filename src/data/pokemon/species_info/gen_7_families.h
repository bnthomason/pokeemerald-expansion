...
#define COSMOG_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_X ? TYPE_LIGHT : TYPE_PSYCHIC)
    ...
    [SPECIES_COSMOG] =
    {
        ...
        .baseSpDefense = 31,
    #endif
        .types = MON_TYPES(COSMOG_FAMILY_TYPE),
        .catchRate = 45,
        .expYield = 40,
        .evYield_HP = 1,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_SOLGALEO] =
    {
        ...
        .baseSpDefense = 89,
    #endif
        .types = MON_TYPES(COSMOG_FAMILY_TYPE, TYPE_STEEL),
        .catchRate = 45,
    ...
    [SPECIES_LUNALA] =
    {
        ...
        .baseSpDefense = 107,
    #endif
        .types = MON_TYPES(COSMOG_FAMILY_TYPE, TYPE_GHOST),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 340 : 306,
        .evYield_SpAttack = 3,
        .genderRatio = MON_GENDERLESS,
...
#define NECROZMA_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_X ? TYPE_LIGHT : TYPE_PSYCHIC)
    ...
    [SPECIES_NECROZMA] =
    {
        ...
        .baseSpDefense = 89,
    #endif
        .types = MON_TYPES(NECROZMA_FAMILY_TYPE),
        .catchRate = 255,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 300 : 270,
        .evYield_Attack = 1,
        .evYield_SpAttack = 2,
    ...
    [SPECIES_NECROZMA_DUSK_MANE] =
    {
        ...
        .baseSpDefense = 109,
    #endif
        .types = MON_TYPES(NECROZMA_FAMILY_TYPE, TYPE_STEEL),
        .catchRate = 255,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 340 : 306,
        .evYield_Attack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_NECROZMA_DAWN_WINGS] =
    {
        ...
        .baseSpDefense = 127,
    #endif
        .types = MON_TYPES(NECROZMA_FAMILY_TYPE, TYPE_GHOST),
        .catchRate = 255,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 340 : 306,
        .evYield_SpAttack = 3,
        .genderRatio = MON_GENDERLESS,
    ...
    [SPECIES_NECROZMA_ULTRA] =
    {
        ...
        .baseSpDefense = 97,
    #endif
        .types = MON_TYPES(NECROZMA_FAMILY_TYPE, TYPE_DRAGON),
        .catchRate = 255,
