...
const u16 gMetatiles_SurvivalIsland[] = INCBIN_U16("data/tilesets/secondary/survival_island/metatiles.bin");
const u16 gMetatileAttributes_SurvivalIsland[] = INCBIN_U16("data/tilesets/secondary/survival_island/metatile_attributes.bin");
