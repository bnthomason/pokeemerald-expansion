...
const u16 gMetatiles_TrainerIsland[] = INCBIN_U16("data/tilesets/secondary/trainer_island/metatiles.bin");
const u16 gMetatileAttributes_TrainerIsland[] = INCBIN_U16("data/tilesets/secondary/trainer_island/metatile_attributes.bin");
