...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_INSIDE_BOAT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_BEACH] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_AREA_1] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_AREA_1_BOSS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_AREA_2] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_AREA_2_BOSS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_AREA_3] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_AREA_3_BOSS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_AREA_4] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_AREA_4_BOSS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_AREA_5] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_AREA_5_BOSS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_AREA_6] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_AREA_6_BOSS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_AREA_F] = MAPPOPUP_THEME_STONE,
    [MAPSEC_AREA_F_BOSS] = MAPPOPUP_THEME_WOOD,
};
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_INSIDE_BOAT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_BEACH] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_AREA_1] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_AREA_1_BOSS] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_AREA_2] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_AREA_2_BOSS] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_AREA_3] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_AREA_3_BOSS] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_AREA_4] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_AREA_4_BOSS] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_AREA_5] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_AREA_5_BOSS] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_AREA_6] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_AREA_6_BOSS] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_AREA_F] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_AREA_F_BOSS] = MAPPOPUP_THEME_BW_DEFAULT,
};
