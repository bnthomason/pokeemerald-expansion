...
struct IslandSelectScreen
{
    ...
    u8 yesNoCursorPos;
    u8 unused;
    struct IslandSelectableMon mons[SELECTABLE_MONS_COUNT];
    struct IslandMonPic monPics[FRONTIER_PARTY_SIZE]; // Array so all chosen mons can be shown at once
...
static void HideMonPic(struct IslandMonPic, bool8 *);
static void CloseMonPic(struct IslandMonPic, bool8 *, bool8);
...
static void Island_SelectReshowMonSprite(void);
static void Island_SelectPrintSelectMonString(void);
static void Island_SelectPrintMonSpecies(void);
static void Island_SelectPrintMonCategory(void);
static void Island_SelectPrintRentalPkmnString(void);
static void Island_SelectCopyMonsToPlayerParty(void);
static void Island_SelectShowChosenMons(void);
static void Island_SelectShowYesNoOptions(void);
static void Island_SelectHideChosenMons(void);
static void Island_SelectShowMenuOptions(void);
static void Island_SelectPrintMenuOptions(void);
static void Island_SelectPrintYesNoOptions(void);
static void Island_SelectTask_FadeSpeciesName(u8);
...
static void Island_SelectErasePopupMenu(u8);
static u8 Island_SelectRunMenuOptionFunc(void);
static u8 Island_SelectDeclineChosenMons(void);
static u8 Island_SelectOptionSummary(void);
static u8 Island_SelectOptionOthers(void);
static u8 Island_SelectOptionRentDeselect(void);
static bool32 Island_SelectAreSpeciesValid(u16);
...
static const struct SpriteSheet sIsland_SelectSpriteSheets[] =
{
...
static const struct CompressedSpriteSheet sIsland_SelectBallGfx[] =
{
    {gPokeballSelection_Gfx, 0x800, GFXTAG_BALL},
    {},
};

static const struct SpritePalette sIsland_SelectSpritePalettes[] =
{
...
u8 static (* const sIsland_SelectMenuOptionFuncs[])(void) =
{
    Island_SelectOptionSummary,
    Island_SelectOptionRentDeselect,
    Island_SelectOptionOthers
};

static const struct BgTemplate sIsland_SelectBgTemplates[] =
{
    {
        .bg = 0,
        .charBaseIndex = 0,
...
static const struct WindowTemplate sIsland_SelectWindowTemplates[] =
{
    [SELECT_WIN_TITLE] = {
        .bg = 0,
        .tilemapLeft = 0,
...
static const struct OamData sOam_Island_SelectPokeball =
{
    .y = 0,
...
static const struct OamData sOam_Island_SelectArrow =
{
    .y = 0,
    .affineMode = ST_OAM_AFFINE_OFF,
    .objMode = ST_OAM_OBJ_NORMAL,
...
static const struct OamData sOam_Island_SelectMenuHighlight =
{
    .y = 0,
    .affineMode = ST_OAM_AFFINE_OFF,
    .objMode = ST_OAM_OBJ_NORMAL,
...
static const struct OamData sOam_Island_SelectMonPicBgAnim =
{
    .y = 0,
...
static const union AnimCmd sAnim_Island_SelectInterface[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_Island_SelectMonPicBgAnim[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_Island_SelectPokeball_Still[] =
{
    ANIMCMD_FRAME(0, 30),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_Island_SelectPokeball_Moving[] =
{
    ANIMCMD_FRAME(16, 4),
    ANIMCMD_FRAME(0, 4),
    ANIMCMD_FRAME(32, 4),
...
static const union AnimCmd * const sAnims_Island_SelectInterface[] =
{
    sAnim_Island_SelectInterface,
};

static const union AnimCmd * const sAnims_Island_SelectMonPicBgAnim[] =
{
    sAnim_Island_SelectMonPicBgAnim,
};

static const union AnimCmd * const sAnims_Island_SelectPokeball[] =
{
    sAnim_Island_SelectPokeball_Still,
    sAnim_Island_SelectPokeball_Moving,
};

static const union AffineAnimCmd sAffineAnim_Island_SelectMonPicBg_Opening[] =
{
...
static const union AffineAnimCmd sAffineAnim_Island_SelectMonPicBg_Closing[] =
{
    AFFINEANIMCMD_FRAME(128, 5, 0, 0),
    AFFINEANIMCMD_FRAME(0, 0, 0, 1),
    AFFINEANIMCMD_FRAME(64, 5, 0, 0),
...
static const union AffineAnimCmd sAffineAnim_Island_SelectMonPicBg_Open[] =
{
    AFFINEANIMCMD_FRAME(256, 256, 0, 0),
    AFFINEANIMCMD_END,
};

static const union AffineAnimCmd * const sAffineAnims_Island_SelectMonPicBgAnim[] =
{
    sAffineAnim_Island_SelectMonPicBg_Opening,
    sAffineAnim_Island_SelectMonPicBg_Closing,
    sAffineAnim_Island_SelectMonPicBg_Open,
};

static const struct SpriteTemplate sSpriteTemplate_Island_SelectPokeball =
{
    .tileTag = GFXTAG_BALL,
    .paletteTag = PALTAG_BALL_GRAY,
    .oam = &sOam_Island_SelectPokeball,
    .anims = sAnims_Island_SelectPokeball,
    .images = NULL,
    .affineAnims = gDummySpriteAffineAnimTable,
    .callback = SpriteCB_Pokeball
};

static const struct SpriteTemplate sSpriteTemplate_Island_SelectArrow =
{
    .tileTag = GFXTAG_ARROW,
    .paletteTag = PALTAG_INTERFACE,
    .oam = &sOam_Island_SelectArrow,
    .anims = sAnims_Island_SelectInterface,
    .images = NULL,
    .affineAnims = gDummySpriteAffineAnimTable,
    .callback = SpriteCallbackDummy
};

static const struct SpriteTemplate sSpriteTemplate_Island_SelectMenuHighlightLeft =
{
    .tileTag = GFXTAG_MENU_HIGHLIGHT_LEFT,
    .paletteTag = PALTAG_INTERFACE,
    .oam = &sOam_Island_SelectMenuHighlight,
    .anims = sAnims_Island_SelectInterface,
    .images = NULL,
    .affineAnims = gDummySpriteAffineAnimTable,
    .callback = SpriteCallbackDummy
...
static const struct SpriteTemplate sSpriteTemplate_Island_SelectMenuHighlightRight =
{
...
static const struct SpriteTemplate sSpriteTemplate_Island_SelectMonPicBgAnim =
{
    .tileTag = GFXTAG_MON_PIC_BG_ANIM,
    .paletteTag = PALTAG_MON_PIC_BG,
    .oam = &sOam_Island_SelectMonPicBgAnim,
    .anims = sAnims_Island_SelectMonPicBgAnim,
    .images = NULL,
    .affineAnims = sAffineAnims_Island_SelectMonPicBgAnim,
    .callback = SpriteCallbackDummy
};
...
// Main select states
// States for the main tasks of the Island_Select functions after initialization, including:
// Island_SelectTask_OpenSummaryScreen, Island_SelectTask_HandleYesNo, Island_SelectTask_HandleMenu, and Island_SelectTask_HandleChooseMons
// Unnecessarily complicated, could easily have just kept states numbered in each task always starting at 0
// There's only one instance (Island_SelectTask_HandleChooseMons) where a non-initial case is used
// Island_SelectTask_Exit has its own straightforward states
...
static void CB2_Island_InitSelectScreen(void)
{
    ...
    {
    case 0:
        TRY_FREE_AND_SET_NULL(sIslandSelectMons);
        SetHBlankCallback(NULL);
        SetVBlankCallback(NULL);
        CpuFill32(0, (void *)VRAM, VRAM_SIZE);
        ResetBgsAndClearDma3BusyFlags(0);
        InitBgsFromTemplates(0, sIsland_SelectBgTemplates, ARRAY_COUNT(sIsland_SelectBgTemplates));
        InitWindows(sIsland_SelectWindowTemplates);
...
#else
        sSelectMonPicBgTilesetBuffer = AllocZeroed(sizeof(gSurvivalIslandMenu_Gfx)); // Incorrect size
#endif
...
#ifdef UBFIX
        if (sIslandSelectScreen && sIslandSelectScreen->fromSummaryScreen)
#else
        if (sIslandSelectScreen->fromSummaryScreen == TRUE)
#endif
            gPlttBufferUnfaded[BG_PLTT_ID(PALNUM_FADE_TEXT) + 4] = sIslandSelectScreen->speciesNameColorBackup;
    ...
    case 3:
        ...
        break;
    case 4:
        LoadSpritePalettes(sIsland_SelectSpritePalettes);
        LoadSpriteSheets(sIsland_SelectSpriteSheets);
        LoadCompressedSpriteSheet(sIsland_SelectBallGfx);
        ShowBg(0);
        ShowBg(1);
...
#endif
        {
            Island_SelectSetWinRegs(88, 152, 32, 96);
            ShowBg(3);
    ...
    case 5:
        ...
        if (sIslandSelectScreen->fromSummaryScreen == TRUE)
#endif
            sIslandSelectScreen->cursorPos = gLastViewedMonIndex;
        Island_SelectInitMonsData();
        Island_SelectInitAllSprites();
        if (sIslandSelectScreen->fromSummaryScreen == TRUE)
            Island_SelectReshowMonSprite();
        gMain.state++;
        break;
    case 6:
        Island_SelectPrintSelectMonString();
        PutWindowTilemap(SELECT_WIN_INFO);
        gMain.state++;
        break;
    case 7:
        Island_SelectPrintMonCategory();
        PutWindowTilemap(SELECT_WIN_MON_CATEGORY);
        gMain.state++;
        break;
    case 8:
        Island_SelectPrintMonSpecies();
        PutWindowTilemap(SELECT_WIN_SPECIES);
        gMain.state++;
        break;
    case 9:
        Island_SelectPrintRentalPkmnString();
        PutWindowTilemap(SELECT_WIN_TITLE);
        gMain.state++;
        break;
    case 10:
        sIslandSelectScreen->fadeSpeciesNameTaskId = CreateTask(Island_SelectTask_FadeSpeciesName, 0);
        if (!sIslandSelectScreen->fromSummaryScreen)
        {
            gTasks[sIslandSelectScreen->fadeSpeciesNameTaskId].tState = FADESTATE_INIT;
            taskId = CreateTask(Island_SelectTask_HandleChooseMons, 0);
            gTasks[taskId].tState = STATE_CHOOSE_MONS_INIT;
        }
        else
        {
            gTasks[sIslandSelectScreen->fadeSpeciesNameTaskId].tState = FADESTATE_RUN;
            sIslandSelectScreen->fadeSpeciesNameActive = FALSE;
...
static void Island_SelectInitMonsData(void)
{
    ...
    if (sIslandSelectScreen != NULL)
        return;

    sIslandSelectScreen = AllocZeroed(sizeof(*sIslandSelectScreen));
    sIslandSelectScreen->cursorPos = 0;
    sIslandSelectScreen->selectingMonsState = 1;
    sIslandSelectScreen->fromSummaryScreen = FALSE;
...
static void Island_SelectInitAllSprites(void)
{
    ...
    for (i = 0; i < SELECTABLE_MONS_COUNT; i++)
    {
        sIslandSelectScreen->mons[i].ballSpriteId = CreateSprite(&sSpriteTemplate_Island_SelectPokeball, (35 * i) + 32, 64, 1);
        gSprites[sIslandSelectScreen->mons[i].ballSpriteId].data[0] = 0;
        Island_SelectSetBallSpritePaletteNum(i);
    }
    cursorPos = sIslandSelectScreen->cursorPos;
    x = gSprites[sIslandSelectScreen->mons[cursorPos].ballSpriteId].x;
    sIslandSelectScreen->cursorSpriteId = CreateSprite(&sSpriteTemplate_Island_SelectArrow, x, 88, 0);
    sIslandSelectScreen->menuCursor1SpriteId = CreateSprite(&sSpriteTemplate_Island_SelectMenuHighlightLeft, 176, 112, 0);
    sIslandSelectScreen->menuCursor2SpriteId = CreateSprite(&sSpriteTemplate_Island_SelectMenuHighlightRight, 176, 144, 0);

    gSprites[sIslandSelectScreen->menuCursor1SpriteId].invisible = TRUE;
    gSprites[sIslandSelectScreen->menuCursor2SpriteId].invisible = TRUE;

    gSprites[sIslandSelectScreen->menuCursor1SpriteId].centerToCornerVecX = 0;
    gSprites[sIslandSelectScreen->menuCursor1SpriteId].centerToCornerVecY = 0;
    gSprites[sIslandSelectScreen->menuCursor2SpriteId].centerToCornerVecX = 0;
    gSprites[sIslandSelectScreen->menuCursor2SpriteId].centerToCornerVecY = 0;
}

static void Island_SelectDestroyAllSprites(void)
{
    u8 i;

    for (i = 0; i < SELECTABLE_MONS_COUNT; i++)
        DestroySprite(&gSprites[sIslandSelectScreen->mons[i].ballSpriteId]);

    DestroySprite(&gSprites[sIslandSelectScreen->cursorSpriteId]);
    DestroySprite(&gSprites[sIslandSelectScreen->menuCursor1SpriteId]);
    DestroySprite(&gSprites[sIslandSelectScreen->menuCursor2SpriteId]);
}

static void Island_SelectUpdateBallCursorPosition(s8 direction)
{
    u8 cursorPos;
    if (direction > 0) // Move cursor right.
    {
        if (sIslandSelectScreen->cursorPos != SELECTABLE_MONS_COUNT - 1)
            sIslandSelectScreen->cursorPos++;
        else
            sIslandSelectScreen->cursorPos = 0;
    }
    else // Move cursor left.
    {
        if (sIslandSelectScreen->cursorPos != 0)
            sIslandSelectScreen->cursorPos--;
        else
            sIslandSelectScreen->cursorPos = SELECTABLE_MONS_COUNT - 1;
    }

    cursorPos = sIslandSelectScreen->cursorPos;
    gSprites[sIslandSelectScreen->cursorSpriteId].x = gSprites[sIslandSelectScreen->mons[cursorPos].ballSpriteId].x;
}

static void Island_SelectUpdateMenuCursorPosition(s8 direction)
{
    if (direction > 0) // Move cursor down.
    {
        if (sIslandSelectScreen->menuCursorPos != ARRAY_COUNT(sIsland_SelectMenuOptionFuncs) - 1)
            sIslandSelectScreen->menuCursorPos++;
        else
            sIslandSelectScreen->menuCursorPos = 0;
    }
    else // Move cursor up.
    {
        if (sIslandSelectScreen->menuCursorPos != 0)
            sIslandSelectScreen->menuCursorPos--;
        else
            sIslandSelectScreen->menuCursorPos = ARRAY_COUNT(sIsland_SelectMenuOptionFuncs) - 1;
    }

    gSprites[sIslandSelectScreen->menuCursor1SpriteId].y = (sIslandSelectScreen->menuCursorPos * 16) + 112;
    gSprites[sIslandSelectScreen->menuCursor2SpriteId].y = (sIslandSelectScreen->menuCursorPos * 16) + 112;
}

static void Island_SelectUpdateYesNoCursorPosition(s8 direction)
{
    if (direction > 0) // Move cursor down.
    {
        if (sIslandSelectScreen->yesNoCursorPos != 1)
            sIslandSelectScreen->yesNoCursorPos++;
        else
            sIslandSelectScreen->yesNoCursorPos = 0;
    }
    else // Move cursor up.
    {
        if (sIslandSelectScreen->yesNoCursorPos != 0)
            sIslandSelectScreen->yesNoCursorPos--;
        else
            sIslandSelectScreen->yesNoCursorPos = 1;
    }

    gSprites[sIslandSelectScreen->menuCursor1SpriteId].y = (sIslandSelectScreen->yesNoCursorPos * 16) + 112;
    gSprites[sIslandSelectScreen->menuCursor2SpriteId].y = (sIslandSelectScreen->yesNoCursorPos * 16) + 112;
}

static void Island_SelectHandleMonSelectionChange(void)
{
    u8 i, paletteNum;
    u8 cursorPos = sIslandSelectScreen->cursorPos;
    if (sIslandSelectScreen->mons[cursorPos].selectedId) // Deselect a mon.
    {
        paletteNum = IndexOfSpritePaletteTag(PALTAG_BALL_GRAY);
        if (sIslandSelectScreen->selectingMonsState == FRONTIER_PARTY_SIZE
         && sIslandSelectScreen->mons[cursorPos].selectedId == 1)
        {
            for (i = 0; i < SELECTABLE_MONS_COUNT; i++)
            {
                if (sIslandSelectScreen->mons[i].selectedId == FRONTIER_PARTY_SIZE - 1)
                    break;
            }
            if (i == SELECTABLE_MONS_COUNT)
                return;
            else
                sIslandSelectScreen->mons[i].selectedId = 1;
        }
        sIslandSelectScreen->mons[cursorPos].selectedId = 0;
        sIslandSelectScreen->selectingMonsState--;
    }
    else // Select a mon.
    {
        paletteNum = IndexOfSpritePaletteTag(PALTAG_BALL_SELECTED);
        sIslandSelectScreen->mons[cursorPos].selectedId = sIslandSelectScreen->selectingMonsState;
        sIslandSelectScreen->selectingMonsState++;
    }

    gSprites[sIslandSelectScreen->mons[cursorPos].ballSpriteId].oam.paletteNum = paletteNum;
}

static void Island_SelectSetBallSpritePaletteNum(u8 id)
{
    u8 palNum;

    if (sIslandSelectScreen->mons[id].selectedId)
        palNum = IndexOfSpritePaletteTag(PALTAG_BALL_SELECTED);
    else
        palNum = IndexOfSpritePaletteTag(PALTAG_BALL_GRAY);

    gSprites[sIslandSelectScreen->mons[id].ballSpriteId].oam.paletteNum = palNum;
}

static void Island_SelectTask_OpenSummaryScreen(u8 taskId)
{
    u8 i;
    u8 currMonId;
    ...
    case STATE_SUMMARY_SHOW:
        sIslandSelectScreen->speciesNameColorBackup = gPlttBufferUnfaded[BG_PLTT_ID(PALNUM_FADE_TEXT) + 4];
        DestroyTask(taskId);
        sIslandSelectScreen->fromSummaryScreen = TRUE;
        currMonId = sIslandSelectScreen->cursorPos;
...
static void Island_SelectTask_Exit(u8 taskId)
{
    if (sIslandSelectScreen->monPicAnimating == TRUE)
        return;
...
// Handles the Yes/No prompt when confirming the 6 selected starter Pokémon
static void Island_SelectTask_HandleYesNo(u8 taskId)
{
    if (sIslandSelectScreen->monPicAnimating == TRUE)
        return;
    ...
    case STATE_YESNO_HANDLE_INPUT:
        if (JOY_NEW(A_BUTTON))
        {
            ...
            if (sIslandSelectScreen->yesNoCursorPos == 0)
            {
                ...
                Island_SelectHideChosenMons();
                gTasks[taskId].tState = 0;
                gTasks[taskId].func = Island_SelectTask_Exit;
            }
            else
            {
                // Selected No, continue choosing Pokémon
                Island_SelectErasePopupMenu(SELECT_WIN_YES_NO);
                Island_SelectDeclineChosenMons();
                sIslandSelectScreen->fadeSpeciesNameActive = TRUE;
                gTasks[taskId].tState = STATE_CHOOSE_MONS_HANDLE_INPUT;
                gTasks[taskId].func = Island_SelectTask_HandleChooseMons;
            }
        }
        ...
        {
            PlaySE(SE_SELECT);
            Island_SelectUpdateYesNoCursorPosition(-1);
        }
...
static void Island_SelectTask_HandleMenu(u8 taskId)
{
    switch (gTasks[taskId].tState)
    {
    case STATE_MENU_INIT:
        if (!sIslandSelectScreen->fromSummaryScreen)
            OpenMonPic(&sIslandSelectScreen->monPics[1].bgSpriteId, &sIslandSelectScreen->monPicAnimating, FALSE);
        gTasks[taskId].tState = STATE_MENU_SHOW_OPTIONS;
        break;
    case STATE_MENU_SHOW_OPTIONS:
        if (sIslandSelectScreen->monPicAnimating != TRUE)
        {
            Island_SelectShowMenuOptions();
            sIslandSelectScreen->fromSummaryScreen = FALSE;
    ...
    case STATE_MENU_HANDLE_INPUT:
        if (JOY_NEW(A_BUTTON))
        {
            u8 retVal;
            PlaySE(SE_SELECT);
            retVal = Island_SelectRunMenuOptionFunc();
            ...
            else if (retVal == SELECT_CONFIRM_MONS)
            {
                ...
                gTasks[taskId].func = Island_SelectTask_HandleYesNo;
            }
            ...
            else // SELECT_SUMMARY
            {
                ...
                gTasks[taskId].func = Island_SelectTask_OpenSummaryScreen;
            }
        }
        else if (JOY_NEW(B_BUTTON))
        {
            PlaySE(SE_SELECT);
            CloseMonPic(sIslandSelectScreen->monPics[1], &sIslandSelectScreen->monPicAnimating, FALSE);
            Island_SelectErasePopupMenu(SELECT_WIN_OPTIONS);
            sIslandSelectScreen->fadeSpeciesNameActive = TRUE;
            gTasks[taskId].tState = STATE_CHOOSE_MONS_HANDLE_INPUT;
            gTasks[taskId].func = Island_SelectTask_HandleChooseMons;
        }
        ...
        {
            PlaySE(SE_SELECT);
            Island_SelectUpdateMenuCursorPosition(-1);
        }
        else if (JOY_REPEAT(DPAD_DOWN))
        {
            PlaySE(SE_SELECT);
    ...
    case STATE_MENU_REINIT:
        if (!gPaletteFade.active)
        {
            if (sIslandSelectScreen->fromSummaryScreen == TRUE)
            {
                gPlttBufferFaded[BG_PLTT_ID(PALNUM_FADE_TEXT) + 4] = sIslandSelectScreen->speciesNameColorBackup;
...
static void Island_SelectTask_HandleChooseMons(u8 taskId)
{
    if (sIslandSelectScreen->monPicAnimating == TRUE)
        return;
    ...
    case STATE_CHOOSE_MONS_HANDLE_INPUT:
        if (JOY_NEW(A_BUTTON))
        {
            ...
            gTasks[taskId].func = Island_SelectTask_HandleMenu;
        }
        else if (JOY_REPEAT(DPAD_LEFT))
        {
            PlaySE(SE_SELECT);
            Island_SelectUpdateBallCursorPosition(-1);
            Island_SelectPrintMonCategory();
            Island_SelectPrintMonSpecies();
        }
...
//    u8 difficulty = gSaveBlock2Ptr->survivalisland.difficulty;
//    u8 challengeNum = gSaveBlock2Ptr->frontier.factoryWinStreaks[battleMode][lvlMode] / 7;
//    u8 rentalRank = 0;

//    gIslandTrainerMons = gSurvivaIslandMons;
...
//    otId = T1_READ_32(gSaveBlock2Ptr->playerTrainerId);
    ...
    for (i = 0; i < SELECTABLE_MONS_COUNT; i++)
    {
        ...
        sIslandSelectScreen->mons[i + firstMonId].monId = monId;
...
//        else
        ...
        CreateFacilityMon(&gFacilityTrainerMons[monId],
                ...
                &sIslandSelectScreen->mons[i + firstMonId].monData);
    }
}
/*
static void CreateSlateportTentSelectableMons(u8 firstMonId)
{
    ...
    for (i = 0; i < SELECTABLE_MONS_COUNT; i++)
    {
        u16 monId = gSaveBlock2Ptr->frontier.rentalMons[i].monId;
        sIslandSelectScreen->mons[i + firstMonId].monId = monId;
        CreateFacilityMon(&gFacilityTrainerMons[monId], level, ivs, otId, 0, &sIslandSelectScreen->mons[i + firstMonId].monData);
    }
}
*/
...
static void Island_SelectCopyMonsToPlayerParty(void)
{
    ...
    for (i = 0; i < FRONTIER_PARTY_SIZE; i++)
    {
        ...
        {
            if (sIslandSelectScreen->mons[j].selectedId == i + 1)
            {
                gPlayerParty[i] = sIslandSelectScreen->mons[j].monData;
                gSaveBlock2Ptr->frontier.rentalMons[i].monId = sIslandSelectScreen->mons[j].monId;
...
static void Island_SelectShowMenuOptions(void)
{
    ...
    gSprites[sIslandSelectScreen->menuCursor1SpriteId].x = 176;
    gSprites[sIslandSelectScreen->menuCursor1SpriteId].y = (sIslandSelectScreen->menuCursorPos * 16) + 112;
    gSprites[sIslandSelectScreen->menuCursor2SpriteId].x = 208;
    gSprites[sIslandSelectScreen->menuCursor2SpriteId].y = (sIslandSelectScreen->menuCursorPos * 16) + 112;

    gSprites[sIslandSelectScreen->menuCursor1SpriteId].invisible = FALSE;
    gSprites[sIslandSelectScreen->menuCursor2SpriteId].invisible = FALSE;

    Island_SelectPrintMenuOptions();
}
...
static void Island_SelectShowYesNoOptions(void)
{
    ...
    gSprites[sIslandSelectScreen->menuCursor1SpriteId].x = 176;
    gSprites[sIslandSelectScreen->menuCursor1SpriteId].y = 112;
    gSprites[sIslandSelectScreen->menuCursor2SpriteId].x = 208;
    gSprites[sIslandSelectScreen->menuCursor2SpriteId].y = 112;

    gSprites[sIslandSelectScreen->menuCursor1SpriteId].invisible = FALSE;
    gSprites[sIslandSelectScreen->menuCursor2SpriteId].invisible = FALSE;

    Island_SelectPrintYesNoOptions();
}

static void Island_SelectErasePopupMenu(u8 windowId)
{
    gSprites[sIslandSelectScreen->menuCursor1SpriteId].invisible = TRUE;
    gSprites[sIslandSelectScreen->menuCursor2SpriteId].invisible = TRUE;
...
static void Island_SelectPrintMonSpecies(void)
{
    u16 species;
    u8 x;
    u8 monId = sIslandSelectScreen->cursorPos;

    FillWindowPixelBuffer(SELECT_WIN_SPECIES, PIXEL_FILL(0));
    species = GetMonData(&sIslandSelectScreen->mons[monId].monData, MON_DATA_SPECIES, NULL);
...
static void Island_SelectPrintSelectMonString(void)
{
    ...
    if (sIslandSelectScreen->selectingMonsState == 1)
        str = gText_SelectFirstPkmn;
    else if (sIslandSelectScreen->selectingMonsState == 2)
        str = gText_SelectSecondPkmn;
    else if (sIslandSelectScreen->selectingMonsState == 3)
...
static void Island_SelectPrintCantSelectSameMon(void)
{
    FillWindowPixelBuffer(SELECT_WIN_INFO, PIXEL_FILL(0));
...
static void Island_SelectPrintMenuOptions(void)
{
    u8 selectedId = sIslandSelectScreen->mons[sIslandSelectScreen->cursorPos].selectedId;
...
static u8 Island_SelectRunMenuOptionFunc(void)
{
    gIslandIsland_SelectCurrentOptionFunc = sIsland_SelectMenuOptionFuncs[sIslandSelectScreen->menuCursorPos];
    return gIslandIsland_SelectCurrentOptionFunc();
}

static u8 Island_SelectOptionRentDeselect(void)
{
    u8 selectedId = sIslandSelectScreen->mons[sIslandSelectScreen->cursorPos].selectedId;
    u16 monId  = sIslandSelectScreen->mons[sIslandSelectScreen->cursorPos].monId;
    if (selectedId == 0 && !Island_SelectAreSpeciesValid(monId))
    {
        Island_SelectPrintCantSelectSameMon();
        Island_SelectErasePopupMenu(SELECT_WIN_OPTIONS);
    ...
    {
        CloseMonPic(sIslandSelectScreen->monPics[1], &sIslandSelectScreen->monPicAnimating, FALSE);
        Island_SelectHandleMonSelectionChange();
        Island_SelectPrintSelectMonString();
        Island_SelectErasePopupMenu(SELECT_WIN_OPTIONS);
        if (sIslandSelectScreen->selectingMonsState > FRONTIER_PARTY_SIZE)
...
static void Island_SelectCreateMonSprite(void)
{
    u8 monId = sIslandSelectScreen->cursorPos;
    struct Pokemon *mon = &sIslandSelectScreen->mons[monId].monData;
    u16 species = GetMonData(mon, MON_DATA_SPECIES, NULL);
    u32 personality = GetMonData(mon, MON_DATA_PERSONALITY, NULL);
    bool8 isShiny = GetMonData(mon, MON_DATA_IS_SHINY, NULL);

    sIslandSelectScreen->monPics[1].monSpriteId = CreateMonPicSprite(species, isShiny, personality, TRUE, 88, 32, 15, TAG_NONE);
    gSprites[sIslandSelectScreen->monPics[1].monSpriteId].centerToCornerVecX = 0;
    gSprites[sIslandSelectScreen->monPics[1].monSpriteId].centerToCornerVecY = 0;

    sIslandSelectScreen->monPicAnimating = FALSE;
}

static void Island_SelectSetMonPicAnimating(bool8 animating)
{
    sIslandSelectScreen->monPicAnimating = animating;
}
...
static void Island_SelectReshowMonSprite(void)
{
    ...
    sIslandSelectScreen->monPics[1].bgSpriteId = CreateSprite(&sSpriteTemplate_Island_SelectMonPicBgAnim, 120, 64, 1);
    StartSpriteAffineAnim(&gSprites[sIslandSelectScreen->monPics[1].bgSpriteId], 2);

    mon = &sIslandSelectScreen->mons[sIslandSelectScreen->cursorPos].monData;
    ...
    gSprites[sIslandSelectScreen->monPics[1].bgSpriteId].invisible = TRUE;
}

static void Island_SelectCreateChosenMonsSprites(void)
{
    u8 i, j;
    ...
    for (i = 0; i < FRONTIER_PARTY_SIZE; i++)
    {
        for (j = 0; j < SELECTABLE_MONS_COUNT; j++)
        {
            if (sIslandSelectScreen->mons[j].selectedId == i + 1)
            {
                struct Pokemon *mon = &sIslandSelectScreen->mons[j].monData;
                u16 species = GetMonData(mon, MON_DATA_SPECIES, NULL);
                u32 personality = GetMonData(mon, MON_DATA_PERSONALITY, NULL);
                bool8 isShiny = GetMonData(mon, MON_DATA_IS_SHINY, NULL);

                sIslandSelectScreen->monPics[i].monSpriteId = CreateMonPicSprite(species, isShiny, personality, TRUE, (i * 72) + 16, 32, i + 13, TAG_NONE);
                gSprites[sIslandSelectScreen->monPics[i].monSpriteId].centerToCornerVecX = 0;
                gSprites[sIslandSelectScreen->monPics[i].monSpriteId].centerToCornerVecY = 0;
                break;
            }
        }
    }
...
static void SpriteCB_OpenChosenMonPics(struct Sprite *sprite)
{
    ...
    if (sprite->affineAnimEnded
        && gSprites[sIslandSelectScreen->monPics[0].bgSpriteId].affineAnimEnded
        && gSprites[sIslandSelectScreen->monPics[2].bgSpriteId].affineAnimEnded)
    {
        sprite->invisible = TRUE;
        gSprites[sIslandSelectScreen->monPics[0].bgSpriteId].invisible = TRUE;
        gSprites[sIslandSelectScreen->monPics[2].bgSpriteId].invisible = TRUE;

        taskId = CreateTask(Island_SelectTask_OpenChosenMonPics, 1);
...
static void SpriteCB_CloseChosenMonPics(struct Sprite *sprite)
{
        ...
        && gSprites[sIslandSelectScreen->monPics[2].bgSpriteId].affineAnimEnded)
    {
        ...
        FreeOamMatrix(gSprites[sIslandSelectScreen->monPics[0].bgSpriteId].oam.matrixNum);
        FreeOamMatrix(gSprites[sIslandSelectScreen->monPics[2].bgSpriteId].oam.matrixNum);

        sIslandSelectScreen->monPicAnimating = FALSE;

        DestroySprite(&gSprites[sIslandSelectScreen->monPics[0].bgSpriteId]);
        DestroySprite(&gSprites[sIslandSelectScreen->monPics[2].bgSpriteId]);
        DestroySprite(sprite);
    }
}

// Task data for Island_SelectTask_OpenChosenMonPics, Island_SelectTask_CloseChosenMonPics, Task_CloseMonPic, and Task_OpenMonPic
...
static void Island_SelectTask_OpenChosenMonPics(u8 taskId)
{
    ...
    default:
        DestroyTask(taskId);
        Island_SelectCreateChosenMonsSprites();
        return;
    }
    task->tState++;
}

static void Island_SelectTask_CloseChosenMonPics(u8 taskId)
{
    struct Task *task = &gTasks[taskId];
    switch (task->tState)
    {
    ...
    default:
        HideBg(3);
        gSprites[sIslandSelectScreen->monPics[1].bgSpriteId].invisible = FALSE;
        gSprites[sIslandSelectScreen->monPics[1].bgSpriteId].callback = SpriteCB_CloseChosenMonPics;
        gSprites[sIslandSelectScreen->monPics[0].bgSpriteId].invisible = FALSE;
        gSprites[sIslandSelectScreen->monPics[0].bgSpriteId].callback = SpriteCallbackDummy;
        gSprites[sIslandSelectScreen->monPics[2].bgSpriteId].invisible = FALSE;
        gSprites[sIslandSelectScreen->monPics[2].bgSpriteId].callback = SpriteCallbackDummy;
        StartSpriteAffineAnim(&gSprites[sIslandSelectScreen->monPics[1].bgSpriteId], 1);
        StartSpriteAffineAnim(&gSprites[sIslandSelectScreen->monPics[0].bgSpriteId], 1);
        StartSpriteAffineAnim(&gSprites[sIslandSelectScreen->monPics[2].bgSpriteId], 1);
        ClearGpuRegBits(REG_OFFSET_DISPCNT, DISPCNT_WIN0_ON);
        DestroyTask(taskId);
        break;
    }
...
{
    sIslandSelectScreen->monPics[1].bgSpriteId = CreateSprite(&sSpriteTemplate_Island_SelectMonPicBgAnim, 120, 64, 1);
    sIslandSelectScreen->monPics[0].bgSpriteId = CreateSprite(&sSpriteTemplate_Island_SelectMonPicBgAnim,  44, 64, 1);
    sIslandSelectScreen->monPics[2].bgSpriteId = CreateSprite(&sSpriteTemplate_Island_SelectMonPicBgAnim, 196, 64, 1);

    gSprites[sIslandSelectScreen->monPics[1].bgSpriteId].callback = SpriteCB_OpenChosenMonPics;
    gSprites[sIslandSelectScreen->monPics[0].bgSpriteId].callback = SpriteCallbackDummy;
    gSprites[sIslandSelectScreen->monPics[2].bgSpriteId].callback = SpriteCallbackDummy;

    sIslandSelectScreen->monPicAnimating = TRUE;
}
...
static void Island_SelectHideChosenMons(void)
{
    ...
    FreeAndDestroyMonPicSprite(sIslandSelectScreen->monPics[0].monSpriteId);
    FreeAndDestroyMonPicSprite(sIslandSelectScreen->monPics[1].monSpriteId);
    FreeAndDestroyMonPicSprite(sIslandSelectScreen->monPics[2].monSpriteId);

    taskId = CreateTask(Island_SelectTask_CloseChosenMonPics, 1);
    gTasks[taskId].func(taskId);

    sIslandSelectScreen->monPicAnimating = TRUE;
}

static void Island_SelectSetWinRegs(s16 mWin0H, s16 nWin0H, s16 mWin0V, s16 nWin0V)
{
    SetGpuRegBits(REG_OFFSET_DISPCNT, DISPCNT_WIN0_ON);
...
static bool32 Island_SelectAreSpeciesValid(u16 monId)
{
    u8 i, j;
    u32 species = gFacilityTrainerMons[monId].species;
    u8 selectState = sIslandSelectScreen->selectingMonsState;

    for (i = 1; i < selectState; i++)
    {
        for (j = 0; j < SELECTABLE_MONS_COUNT; j++)
        {
            if (sIslandSelectScreen->mons[j].selectedId == i)
            {
                if (gFacilityTrainerMons[sIslandSelectScreen->mons[j].monId].species == species)
                    return FALSE;
...
static void Island_SelectTask_FadeSpeciesName(u8 taskId)
{
    switch (gTasks[taskId].tState)
    {
    case FADESTATE_INIT:
        sIslandSelectScreen->fadeSpeciesNameCoeffDelay = 0;
        sIslandSelectScreen->fadeSpeciesNameCoeff = 0;
        sIslandSelectScreen->fadeSpeciesNameFadeOut = TRUE;
        gTasks[taskId].tState = FADESTATE_RUN;
        break;
    case FADESTATE_RUN:
        if (sIslandSelectScreen->fadeSpeciesNameActive)
        {
            if (sIslandSelectScreen->faceSpeciesNameDelay)
            {
                gTasks[taskId].tState = FADESTATE_DELAY;
            }
            else
            {
                sIslandSelectScreen->fadeSpeciesNameCoeffDelay++;
                if (sIslandSelectScreen->fadeSpeciesNameCoeffDelay > 6)
                {
                    sIslandSelectScreen->fadeSpeciesNameCoeffDelay = 0;
                    if (!sIslandSelectScreen->fadeSpeciesNameFadeOut)
                        sIslandSelectScreen->fadeSpeciesNameCoeff--;
                    else
                        sIslandSelectScreen->fadeSpeciesNameCoeff++;
                }
                BlendPalettes(1 << PALNUM_FADE_TEXT, sIslandSelectScreen->fadeSpeciesNameCoeff, 0);
                if (sIslandSelectScreen->fadeSpeciesNameCoeff > 5)
                {
                    sIslandSelectScreen->fadeSpeciesNameFadeOut = FALSE;
                }
                else if (sIslandSelectScreen->fadeSpeciesNameCoeff == 0)
                {
                    gTasks[taskId].tState = FADESTATE_DELAY;
                    sIslandSelectScreen->fadeSpeciesNameFadeOut = TRUE;
                }
    ...
    case FADESTATE_DELAY:
        if (sIslandSelectScreen->faceSpeciesNameDelay > 14)
        {
            sIslandSelectScreen->faceSpeciesNameDelay = 0;
            gTasks[taskId].tState = FADESTATE_RUN;
        }
        else
        {
            sIslandSelectScreen->faceSpeciesNameDelay++;
        }
        break;
    }
}
...
static void CopySwappedMonData(void)
{
    ...
    gPlayerParty[sIslandSwapScreen->playerMonId] = gEnemyParty[sIslandSwapScreen->enemyMonId];
    friendship = 0;
    SetMonData(&gPlayerParty[sIslandSwapScreen->playerMonId], MON_DATA_FRIENDSHIP, &friendship);
    gSaveBlock2Ptr->frontier.rentalMons[sIslandSwapScreen->playerMonId].monId = gSaveBlock2Ptr->frontier.rentalMons[sIslandSwapScreen->enemyMonId + FRONTIER_PARTY_SIZE].monId;
    gSaveBlock2Ptr->frontier.rentalMons[sIslandSwapScreen->playerMonId].ivs = gSaveBlock2Ptr->frontier.rentalMons[sIslandSwapScreen->enemyMonId + FRONTIER_PARTY_SIZE].ivs;
    gSaveBlock2Ptr->frontier.rentalMons[sIslandSwapScreen->playerMonId].personality = GetMonData(&gEnemyParty[sIslandSwapScreen->enemyMonId], MON_DATA_PERSONALITY, NULL);
    gSaveBlock2Ptr->frontier.rentalMons[sIslandSwapScreen->playerMonId].abilityNum = GetBoxMonData(&gEnemyParty[sIslandSwapScreen->enemyMonId].box, MON_DATA_ABILITY_NUM, NULL);
}
...
static void Swap_Task_OpenSummaryScreen(u8 taskId)
{
    ...
    case STATE_SUMMARY_SHOW:
        DestroyTask(taskId);
        sIslandSwapScreen->fromSummaryScreen = TRUE;
        sIslandSwapScreen->speciesNameColorBackup = gPlttBufferUnfaded[BG_PLTT_ID(PALNUM_TEXT) + 4];
        ShowPokemonSummaryScreen(SUMMARY_MODE_NORMAL, gPlayerParty, sIslandSwapScreen->cursorPos, FRONTIER_PARTY_SIZE - 1, CB2_InitSwapScreen);
        break;
    }
}
...
static void Swap_Task_Exit(u8 taskId)
{
    ...
    case 0:
        ...
        if (sIslandSwapScreen->monSwapped == TRUE)
        {
            gTasks[taskId].tState++;
    ...
    case 1:
        if (sIslandSwapScreen->monSwapped == TRUE)
        {
            sIslandSwapScreen->enemyMonId = sIslandSwapScreen->cursorPos;
            CopySwappedMonData();
        }
        gTasks[taskId].tState++;
        break;
...
static void Swap_Task_HandleYesNo(u8 taskId)
{
    ...
    case STATE_YESNO_HANDLE_INPUT:
        ...
        {
            PlaySE(SE_SELECT);
            if (sIslandSwapScreen->yesNoCursorPos == 0)
            {
                // Selected Yes
...
static void Swap_Task_FadeSpeciesName(u8 taskId)
{
    ...
    case FADESTATE_INIT:
        ...
        sIslandSwapScreen->fadeSpeciesNameCoeff = 0;
        sIslandSwapScreen->fadeSpeciesNameFadeOut = TRUE;
        gTasks[taskId].tState = FADESTATE_RUN;
        break;
    case FADESTATE_RUN:
        if (sIslandSwapScreen->fadeSpeciesNameActive)
        {
            if (sIslandSwapScreen->faceSpeciesNameDelay)
            {
                gTasks[taskId].tState = FADESTATE_DELAY;
            }
            else
            {
                sIslandSwapScreen->fadeSpeciesNameCoeffDelay++;
                if (sIslandSwapScreen->fadeSpeciesNameCoeffDelay > 6)
                {
                    sIslandSwapScreen->fadeSpeciesNameCoeffDelay = 0;
                    if (!sIslandSwapScreen->fadeSpeciesNameFadeOut)
                        sIslandSwapScreen->fadeSpeciesNameCoeff--;
                    else
                        sIslandSwapScreen->fadeSpeciesNameCoeff++;
                }
                BlendPalettes(1 << PALNUM_FADE_TEXT, sIslandSwapScreen->fadeSpeciesNameCoeff, 0);
                if (sIslandSwapScreen->fadeSpeciesNameCoeff > 5)
                {
                    sIslandSwapScreen->fadeSpeciesNameFadeOut = FALSE;
                }
                else if (sIslandSwapScreen->fadeSpeciesNameCoeff == 0)
                {
                    gTasks[taskId].tState = FADESTATE_DELAY;
                    sIslandSwapScreen->fadeSpeciesNameFadeOut = TRUE;
                }
        ...
        break;
    case FADESTATE_DELAY:
        if (sIslandSwapScreen->faceSpeciesNameDelay > 14)
        {
            sIslandSwapScreen->faceSpeciesNameDelay = 0;
            gTasks[taskId].tState = FADESTATE_RUN;
        }
        else
        {
            sIslandSwapScreen->faceSpeciesNameDelay++;
        }
        break;
    }
}
...
static void Swap_Task_FadeOutSpeciesName(u8 taskId)
{
    ...
    case 1:
        ...
        break;
    case 2:
        if (sIslandSwapScreen->fadeSpeciesNameCoeff > 15)
        {
            gTasks[taskId].tFadeOutFinished = TRUE;
            gTasks[taskId].tState++;
        }
        sIslandSwapScreen->fadeSpeciesNameCoeffDelay++;
        if (sIslandSwapScreen->fadeSpeciesNameCoeffDelay > 3)
        {
            sIslandSwapScreen->fadeSpeciesNameCoeffDelay = 0;
...
static void Swap_Task_SlideCycleBalls(u8 taskId)
{
    ...
    case 1:
        ...
        for (i = FRONTIER_PARTY_SIZE - 1; i >= 0; i--)
        {
            ...
            {
                u8 posX = lastX - gSprites[sIslandSwapScreen->ballSpriteIds[i]].x;
                if (posX == 16 || gTasks[taskId].tBallCycled(i + 1) == TRUE)
                {
                    lastX = gSprites[sIslandSwapScreen->ballSpriteIds[i]].x;
                    gSprites[sIslandSwapScreen->ballSpriteIds[i]].x += 10;
                }
                else if (posX > 16)
                {
                    gSprites[sIslandSwapScreen->ballSpriteIds[i]].x = gSprites[sIslandSwapScreen->ballSpriteIds[i + 1]].x - 48;
                }
            }
            else
            {
            ...
            if (gTasks[taskId].tBallCycled(i) == TRUE)
            {
                ...
                if (gSprites[sIslandSwapScreen->ballSpriteIds[i]].x > (i * 48) + 72)
                {
                    // Overshot dest, set x and finish
                    gSprites[sIslandSwapScreen->ballSpriteIds[i]].x = (i * 48) + 72;
                    finished = TRUE;
                }
                else if (gSprites[sIslandSwapScreen->ballSpriteIds[i]].x == (i * 48) + 72)
                {
                    finished = TRUE;
                }
                else
            ...
            if (gSprites[sIslandSwapScreen->ballSpriteIds[i]].x - 16 > DISPLAY_WIDTH)
            {
                // Ball is offscreen right, cycle its palette and move to left side of screen
                lastX = gSprites[sIslandSwapScreen->ballSpriteIds[i]].x;
                gSprites[sIslandSwapScreen->ballSpriteIds[i]].x = -16;
                if (sIslandSwapScreen->inEnemyScreen == TRUE)
                    gSprites[sIslandSwapScreen->ballSpriteIds[i]].oam.paletteNum = IndexOfSpritePaletteTag(PALTAG_BALL_SELECTED);
                else
                    gSprites[sIslandSwapScreen->ballSpriteIds[i]].oam.paletteNum = IndexOfSpritePaletteTag(PALTAG_BALL_GRAY);
...
static void Swap_Task_SlideButtonOnOffScreen(u8 taskId)
{
    ...
    case SLIDE_BUTTON_PKMN:
        currPosX = gSprites[sIslandSwapScreen->pkmnForSwapButtonSpriteIds[0][0]].x;
        ...
        if (sliding == TRUE)
        {
            ...
            {
                for (j = 0; j < ARRAY_COUNT(sIslandSwapScreen->pkmnForSwapButtonSpriteIds); j++)
                    gSprites[sIslandSwapScreen->pkmnForSwapButtonSpriteIds[j][i]].x += deltaX;
            }
        }
        else
        {
            ...
            for (j = 0; j < ARRAY_COUNT(sIslandSwapScreen->pkmnForSwapButtonSpriteIds); j++)
            {
                gSprites[sIslandSwapScreen->pkmnForSwapButtonSpriteIds[j][0]].x = posX;
                gSprites[sIslandSwapScreen->pkmnForSwapButtonSpriteIds[j][1]].x = posX + 16;
                gSprites[sIslandSwapScreen->pkmnForSwapButtonSpriteIds[j][2]].x = posX + 48;
            }
    ...
    case SLIDE_BUTTON_CANCEL:
        currPosX = gSprites[sIslandSwapScreen->cancelButtonSpriteIds[0][0]].x;
        if (!gTasks[taskId].tSlidingOn)
        {
        ...
        {
            // Do movement
            for (i = 0; i < ARRAY_COUNT(sIslandSwapScreen->cancelButtonSpriteIds); i++)
            {
                for (j = 0; j < ARRAY_COUNT(sIslandSwapScreen->cancelButtonSpriteIds[0]); j++)
                    gSprites[sIslandSwapScreen->cancelButtonSpriteIds[j][i]].x += deltaX;
            }
        }
        else
        {
            // Set final position
            for (j = 0; j < ARRAY_COUNT(sIslandSwapScreen->cancelButtonSpriteIds); j++)
            {
                gSprites[sIslandSwapScreen->cancelButtonSpriteIds[j][0]].x = posX;
                gSprites[sIslandSwapScreen->cancelButtonSpriteIds[j][1]].x = posX + 16;
            }
            prevTaskId = gTasks[taskId].tTaskId;
...
static void Swap_InitStruct(void)
{
    ...
    {
        sIslandSwapScreen = AllocZeroed(sizeof(*sIslandSwapScreen));
...
static void CB2_InitSwapScreen(void)
{
    ...
    case 5:
#ifdef UBFIX
        if (sIslandSwapScreen && sIslandSwapScreen->fromSummaryScreen)
#else
        if (sIslandSwapScreen->fromSummaryScreen == TRUE)
#endif
            sIslandSwapScreen->cursorPos = gLastViewedMonIndex;
        gMain.state++;
        break;
    case 6:
        Swap_InitStruct();
...
static void Swap_InitAllSprites(void)
{
    ...
    gSprites[sIslandSwapScreen->menuCursor1SpriteId].centerToCornerVecY = 0;
    gSprites[sIslandSwapScreen->menuCursor2SpriteId].centerToCornerVecX = 0;
    gSprites[sIslandSwapScreen->menuCursor2SpriteId].centerToCornerVecY = 0;
    ...
    for (i = 0; i < 2; i++)
    {
        gSprites[sIslandSwapScreen->pkmnForSwapButtonSpriteIds[i][0]].centerToCornerVecX = 0;
        gSprites[sIslandSwapScreen->pkmnForSwapButtonSpriteIds[i][0]].centerToCornerVecY = 0;
        gSprites[sIslandSwapScreen->pkmnForSwapButtonSpriteIds[i][1]].centerToCornerVecX = 0;
        gSprites[sIslandSwapScreen->pkmnForSwapButtonSpriteIds[i][1]].centerToCornerVecY = 0;
        gSprites[sIslandSwapScreen->pkmnForSwapButtonSpriteIds[i][2]].centerToCornerVecX = 0;
        gSprites[sIslandSwapScreen->pkmnForSwapButtonSpriteIds[i][2]].centerToCornerVecY = 0;
        gSprites[sIslandSwapScreen->cancelButtonSpriteIds[i][0]].centerToCornerVecX = 0;
        gSprites[sIslandSwapScreen->cancelButtonSpriteIds[i][0]].centerToCornerVecY = 0;
        gSprites[sIslandSwapScreen->cancelButtonSpriteIds[i][1]].centerToCornerVecX = 0;
        gSprites[sIslandSwapScreen->cancelButtonSpriteIds[i][1]].centerToCornerVecY = 0;

        gSprites[sIslandSwapScreen->pkmnForSwapButtonSpriteIds[i][0]].invisible = TRUE;
        gSprites[sIslandSwapScreen->pkmnForSwapButtonSpriteIds[i][1]].invisible = TRUE;
        gSprites[sIslandSwapScreen->pkmnForSwapButtonSpriteIds[i][2]].invisible = TRUE;
        gSprites[sIslandSwapScreen->cancelButtonSpriteIds[i][0]].invisible = TRUE;
        gSprites[sIslandSwapScreen->cancelButtonSpriteIds[i][1]].invisible = TRUE;
    }

    gSprites[sIslandSwapScreen->cancelButtonSpriteIds[0][0]].invisible = FALSE;
    gSprites[sIslandSwapScreen->cancelButtonSpriteIds[0][1]].invisible = FALSE;
    gSprites[sIslandSwapScreen->pkmnForSwapButtonSpriteIds[0][0]].invisible = FALSE;
    gSprites[sIslandSwapScreen->pkmnForSwapButtonSpriteIds[0][1]].invisible = FALSE;
...
static void Swap_DestroyAllSprites(void)
{
    ...
    for (i = 0; i < FRONTIER_PARTY_SIZE; i++)
        DestroySprite(&gSprites[sIslandSwapScreen->ballSpriteIds[i]]);
    DestroySprite(&gSprites[sIslandSwapScreen->cursorSpriteId]);
    DestroySprite(&gSprites[sIslandSwapScreen->menuCursor1SpriteId]);
    DestroySprite(&gSprites[sIslandSwapScreen->menuCursor2SpriteId]);
    for (i = 0; i < ARRAY_COUNT(sIslandSwapScreen->pkmnForSwapButtonSpriteIds); i++)
    {
        for (j = 0; j < ARRAY_COUNT(sIslandSwapScreen->pkmnForSwapButtonSpriteIds[0]); j++)
            DestroySprite(&gSprites[sIslandSwapScreen->pkmnForSwapButtonSpriteIds[i][j]]);
    }
    for (i = 0; i < ARRAY_COUNT(sIslandSwapScreen->cancelButtonSpriteIds); i++)
    {
        for (j = 0; j < ARRAY_COUNT(sIslandSwapScreen->cancelButtonSpriteIds[0]); j++)
            DestroySprite(&gSprites[sIslandSwapScreen->cancelButtonSpriteIds[i][j]]);
    }
}
...
static void Swap_UpdateBallCursorPosition(s8 direction)
{
    ...
    if (direction > 0) // Move cursor right.
    {
        if (sIslandSwapScreen->cursorPos + 1 != sIslandSwapScreen->actionsCount)
            sIslandSwapScreen->cursorPos++;
        else
            sIslandSwapScreen->cursorPos = 0;
    }
    else // Move cursor left.
    {
        if (sIslandSwapScreen->cursorPos != 0)
            sIslandSwapScreen->cursorPos--;
        else
            sIslandSwapScreen->cursorPos = sIslandSwapScreen->actionsCount - 1;
    }
...
static void Swap_UpdateActionCursorPosition(s8 direction)
{
    ...
    {
        if (sIslandSwapScreen->cursorPos < FRONTIER_PARTY_SIZE)
            sIslandSwapScreen->cursorPos = FRONTIER_PARTY_SIZE;
        else if (sIslandSwapScreen->cursorPos + 1 != sIslandSwapScreen->actionsCount)
            sIslandSwapScreen->cursorPos++;
        else
            sIslandSwapScreen->cursorPos = 0;
    }
    else // Move cursor up.
    {
        if (sIslandSwapScreen->cursorPos < FRONTIER_PARTY_SIZE)
            sIslandSwapScreen->cursorPos = sIslandSwapScreen->actionsCount - 1;
        else if (sIslandSwapScreen->cursorPos != 0)
            sIslandSwapScreen->cursorPos--;
        else
            sIslandSwapScreen->cursorPos = sIslandSwapScreen->actionsCount - 1;
    }
...
static void Swap_UpdateYesNoCursorPosition(s8 direction)
{
    if (direction > 0) // Move cursor down.
    {
        if (sIslandSwapScreen->yesNoCursorPos != 1)
            sIslandSwapScreen->yesNoCursorPos++;
        else
    ...
    else // Move cursor up.
    {
        if (sIslandSwapScreen->yesNoCursorPos != 0)
            ...
            sIslandSwapScreen->yesNoCursorPos = 1;
    }

    gSprites[sIslandSwapScreen->menuCursor1SpriteId].y = (sIslandSwapScreen->yesNoCursorPos * 16) + 112;
...
static void Swap_HighlightActionButton(u8 actionId)
{
    ...
    for (i = 0; i < ARRAY_COUNT(sIslandSwapScreen->pkmnForSwapButtonSpriteIds[0]); i++)
    {
        if (actionId == SWAPACTION_PKMN_FOR_SWAP)
        {
            ...
            gSprites[sIslandSwapScreen->pkmnForSwapButtonSpriteIds[1][i]].invisible = FALSE;

            // Hide button highlight on Cancel
            if (i < ARRAY_COUNT(sIslandSwapScreen->cancelButtonSpriteIds[0]))
                gSprites[sIslandSwapScreen->cancelButtonSpriteIds[1][i]].invisible = TRUE;
        }
        else if (actionId == SWAPACTION_CANCEL)
        {
            // Show button highlight on Cancel
            if (i < ARRAY_COUNT(sIslandSwapScreen->cancelButtonSpriteIds[0]))
                gSprites[sIslandSwapScreen->cancelButtonSpriteIds[1][i]].invisible = FALSE;
...
static void Swap_ShowMenuOptions(void)
{
    ...
    gSprites[sIslandSwapScreen->menuCursor1SpriteId].x = 176;
    gSprites[sIslandSwapScreen->menuCursor1SpriteId].y = (sIslandSwapScreen->menuCursorPos * 16) + 112;
    gSprites[sIslandSwapScreen->menuCursor2SpriteId].x = 208;
    gSprites[sIslandSwapScreen->menuCursor2SpriteId].y = (sIslandSwapScreen->menuCursorPos * 16) + 112;
...
static void Swap_ShowYesNoOptions(void)
{
    ...
    gSprites[sIslandSwapScreen->menuCursor1SpriteId].x = 176;
    gSprites[sIslandSwapScreen->menuCursor1SpriteId].y = 112;
    gSprites[sIslandSwapScreen->menuCursor2SpriteId].x = 208;
    gSprites[sIslandSwapScreen->menuCursor2SpriteId].y = 112;
...
static void Swap_PrintMonSpecies(void)
{
    ...
    {
        u8 monId = sIslandSwapScreen->cursorPos;
        if (!sIslandSwapScreen->inEnemyScreen)
...
static void Swap_ShowSummaryMonSprite(void)
{
    ...
    sIslandSwapScreen->monPic.monSpriteId = CreateMonPicSprite(species, isShiny, personality, TRUE, 88, 32, 15, TAG_NONE);
    gSprites[sIslandSwapScreen->monPic.monSpriteId].centerToCornerVecX = 0;
...
static bool8 Swap_AlreadyHasSameSpecies(u8 monId)
{
    ...
    for (i = 0; i < FRONTIER_PARTY_SIZE; i++)
    {
        if (i != sIslandSwapScreen->playerMonId && (u16)(GetMonData(&gPlayerParty[i], MON_DATA_SPECIES, NULL)) == species)
            return TRUE;
    }
    return FALSE;
}
...
static void Swap_CreateMonSprite(void)
{
    ...
    if (!sIslandSwapScreen->inEnemyScreen)
        ...
        mon = &gEnemyParty[sIslandSwapScreen->cursorPos];
